...
export default class BoardCard extends ReduxMixin(PolymerElement) {
      ...
      <div id="card">
        ...
        <div back>
          <div id="info">
            ...
            <paper-input label="[[lName]]" value="{{board.name}}" on-change="onChangeName"></paper-input>
  ...
  onClickEdit(e) {
    this.dispatch(setRoute('modeler', this.board.id));
    e.stopPropagation();
  }

  onClickViewer(e) {
    this.dispatch(setRoute('viewer', this.board.id));
    e.stopPropagation();
  }
